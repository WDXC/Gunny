...
Game::Game(const std::string &windowName, const int width, const int height)
  ...
  // we need new size due to possible high resolution on mac or ios
  int w, h;
...
SceneManager *Game::getSceneManager() const { return sceneManager; }

AssetManager *Game::getAssetManager() const { return assetManager; }
